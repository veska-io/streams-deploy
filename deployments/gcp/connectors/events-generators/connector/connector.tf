# Cloud Function
resource "google_cloudfunctions2_function" "events_generator" {
  name = var.name
  ...
  service_config {
    ...
    environment_variables = {
      ...
      CONNECTOR_PUBSUB-PRODUCER_TOPIC-ID   = var.events_topic_id
      CONNECTOR_PUBSUB-PRODUCER_PROJECT-ID = "veska-io"
    }
  }
